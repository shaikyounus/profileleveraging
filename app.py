...
app.config['UPLOAD_FOLDER'] = r'F:\Capstone\Profile-Leveraging\Upload-Resume'
app.config['UPLOAD_JD_FOLDER'] = r'F:\Capstone\Profile-Leveraging\Upload-Jobdescription'
